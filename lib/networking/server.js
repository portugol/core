...
Server.prototype.start = function() {
  ...
  io.sockets.on('connection', function (socket) {
    ...
    socket.on('flowchart', function (data) {
      data='[{"root": {"type": 1,"data": "null","uuid": 4,"next":{"type": 3,"data": "Click me","uuid": 10,"next":{"type": 2,"data": "null","uuid": 7}}}}]';
      data = JSON.parse(data);
      console.log("ROOT______________________");
      console.log(util.inspect(data));
      console.log(data[0]);
      console.log(data[0].root);
      var graph = new Graph();
      try {
