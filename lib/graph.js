...
//Construtor de objectos GRAPH. Recebe como parâmetro o elemento inicial dao fluxograma
...
Graph.prototype.validate = function(node) {
  ...
  switch(node.type) {
    ...
    case Definition.END:
      //Se ainda não encontrou um END ou existem elementos para além do final. É lançada uma excepção
